describe('Покупка аватара', function () {                               // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[type="email"]').type('ksenia.vologodskaya@yandex.ru');      // вводим логин
         cy.get('input[type="password"]').type('sjQ-Vmh-BqY-32G');    // вводим пароль
         ...
         cy.get('.k_input_name').type('xeniia vologodskaya');                           // вводим имя владельца действия карты
